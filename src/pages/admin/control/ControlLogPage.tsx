  ...
  return (
    <AdminLayout>
      <div>
        ...
        <p className="text-muted-foreground mb-4 text-sm">Полный журнал действий всех AI-агентов</p>
        ...
        <Card>
          <Table>
            ...
            <TableBody>
              {logs.length === 0 && <TableRow><TableCell colSpan={6} className="text-center text-muted-foreground py-8">Журнал пуст</TableCell></TableRow>}
              {logs.map(log => (
                <TableRow key={log.id}>
